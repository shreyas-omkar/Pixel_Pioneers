        ...
        <div className='w-full px-4 py-10'>
            ...
            <div className="cover flex flex-row px-4 w-full justify-center lg:justify-normal">
                ...
                <div className="right-element px-8 py-10 rounded-3xl lg:flex bg-black lg:flex-col lg:items-center justify-center align-middle lg:justify-center lg:w-1/2 lg:px-8 lg:text-center">
                    ...
                    <form onSubmit={(e) => navigate('/thanks')} className='mt-8 justify-center text-center w-full lg:flex lg:flex-col lg:items-center lg:justify-center'>
                        <div className="input-cover py-5 flex flex-row items-center lg:w-full lg:max-w-md lg:justify-center">
                            ...
                            <span className="w-full max-w-xs lg:max-w-md">
                                <input className=" px-4 py-3 leading-9 w-full max-w-full  bg-transparent border-solid border-b-2 focus:border-white border-semiLight outline-none font-body text-white" type="email" required name="Email" id="Email_Register" placeholder='youremail@example.com'  />
                            </span>
                        </div>
                        <div className="input-cover py-5 flex flex-row items-center lg:w-full lg:max-w-md lg:justify-center">
                            <span className="align-middle">
                            ...
                            <span className="w-full max-w-xs lg:max-w-md">
                                <input className=" px-4 py-3 leading-9 w-full max-w-full  bg-transparent border-solid border-b-2 focus:border-white border-semiLight outline-none font-body text-white" type="password" required name="Password" id="Password_Register" placeholder='At Least 6 Characters'  />
                            </span>
                        </div>
